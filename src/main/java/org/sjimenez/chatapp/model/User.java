...
public class User {
	...
	public boolean equals(Object o) {
		...
		return getIduser() == user.getIduser() && Objects.equals(getName(), user.getName())
				&& Objects.equals(getLastName(), user.getLastName()) && Objects.equals(getMail(), user.getMail())
	...
	public String toString() {
		return "User{" + "iduser=" + iduser + ", name='" + name + '\'' + ", lastName='" + lastName + '\'' + ", mail='"
				+ mail + '\'' + ", birthdate=" + birthdate + ", nickname='" + nickname + '\'' + '}';
	}
}
